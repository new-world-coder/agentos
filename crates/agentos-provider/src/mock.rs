...
use agentos_core::{ProposedEffect, Result};
...
impl Provider for MockProvider {
    ...
    async fn complete(&self, request: ProviderRequest) -> Result<ProviderResponse> {
        ...
        let answer = request
            ...
            .iter()
            .rev()
            .find(|m| matches!(m.role, agentos_core::Role::User))
...
mod tests {
    ...
    async fn mock_follows_script() {
        ...
        let r2 = provider
            ...
            .await
            .unwrap();
        assert_eq!(r2.effects[0].kind, agentos_core::EffectKind::Complete);
    }
}
